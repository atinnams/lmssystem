...
<div class="navigation">
    <% if (session.getAttribute("Cust") != null ||session.getAttribute("Admin") != null )
    {
    %>
    <h2><img src="images/cust.jpg" alt="">Khách hàng</h2>
    <ul>
        <li><a href="index.jsp?TaskID=2">Thông tin khách hàng</a></li>
        <li><a href="index.jsp?TaskID=16">Thông tin thẻ</a></li>
        <li><a href="index.jsp?TaskID=17">Thông tin giao dịch</a></li>
    </ul>
    <%
    }
    %>
    ...
    %>
        ...
        <ul>
            <li><a href="index.jsp?TaskID=2">Tìm kiếm khách hàng</a></li>            
