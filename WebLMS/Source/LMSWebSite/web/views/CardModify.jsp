                                ...
                                <div class="content">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td><input type="text" value="<%=card.getJPOS_CardId()%>" name="txtMaThe" disabled</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <%
                                                     ...
                                                     {
                                                        %><%=card.getCustomerOwnerID() %>&nbsp;&nbsp; <a href="index.jsp?TaskID=9&CardTask=8&CardID=<%=card.getJPOS_CardId() %>" title="Cấp lại thẻ">(Cấp lại)</a></td><%
                                                     }
