 ...
 * 
 * @author HUNGPT
 * Purpose of this test case is used to check PoSCC that is not supported.
 */
public class InvalidPoSCCCase extends TestCase {

	public InvalidPoSCCCase(String name) {
		super(name);
	}
	
	public void testInvalidPoSCC(){
		try {
			...
			assertEquals("58",r.getValue(39));
			assertEquals(Constant.POSCC_NOT_FOUND,r.getValue(62));
			// close connection
			channel.disconnect();
