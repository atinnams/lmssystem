 ...
 * 
 * @author HUNGPT
 * Purpose of this test case is used to check invalid merchant or Terminal Id error.
 */
public class InvalidMerchantCase extends TestCase {

	public InvalidMerchantCase(String name) {
		super(name);
	}
	...
	public void testInvalidMerchant() {
		try {
			...
			assertEquals("03",r.getValue(39));
			assertEquals(Constant.MID_OR_TID_NOT_FOUND,r.getValue(62));
			// close connection
			channel.disconnect();
