<%-- 
    Document   : AdminList
    Created on : Jun 16, 2010, 9:01:42 PM
    Author     : NKLapTop
--%>
                                        ...
                                        <tr>
                                            <td align="left" width="630px">
                                                <form action="index.jsp">
                                                    <input type="Hidden" value="14" name="TaskID"/>
                                                    <input type="Hidden" value="11" name="AdminTask"/>
                                                    <span>Tìm kiếm : </span>
                                                    <input type="text" value="" name="Search"/>
                                                    <input type="submit" value="Tìm">
                                                </form>
                                            </td>
                                            <td align="right"><a href="index.jsp?TaskID=14&AdminTask=1"><img src="images/AddNew.jpg"></a></td>
                                            <td align="left"><a href="index.jsp?TaskID=14&AdminTask=1">Thêm tài khoản</a></td>
                                        </tr>
                                ...
                                <% if (resultViews == null)
                                   ...
                                   else
                                   {
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="1px"  width="774px" >
                                            ...
                                            {
                                                DTO.DTO_JPOS_Admin admin = (DTO.DTO_JPOS_Admin)resultViews.get(i);
                                                String strJoinDay = "";
                                                if (admin.getDateJoin() != null)
                                                    strJoinDay = dateFormat.format(admin.getDateJoin());
                                                %>
                                                <ex:searchresults>
                                                <pg:item>
                                                    <tr align="center">
                                                        ...
                                                        <td>
                                                            <a href="index.jsp?TaskID=14&AdminTask=6&User=<%=admin.getUsername() %>" title="Chi tiết tài khoản"><img src="images/detail.jpg"></a>
                                                            <a href="index.jsp?TaskID=14&AdminTask=7&User=<%=admin.getUsername() %>" title="Thay đổi thông tin"><img src="images/modify.jpg"></a>
                                                            <a href="index.jsp?TaskID=14&AdminTask=3&User=<%=admin.getUsername() %>" title="Xóa tài khoản"><img src="images/delete.jpg"></a>
                                                        </td>
                                                    </tr>
                                                </pg:item>
                                                </ex:searchresults>
