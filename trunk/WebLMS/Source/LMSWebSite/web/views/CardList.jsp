...
%>
                    ...
                    <tr>
                        <td colspan="9">
                            <div >
                                <center><h1>DANH SÁCH THẺ CUNG CẤP</h1></center>
                                <br>
                                <%
                                   ...
                                   else
                                   {
                                        ...
                                        for (int i= 0 ; i < iSize; i++ )
                                        {
                                            ...
                                            <tr align="center">
                                                ...
                                                <td>
                                                    <a href="index.jsp?TaskID=9&CardTask=6&CardID=<%=card.getJPOS_CardId() %>"><img src="images/detail.jpg"></a>
                                                    <a href="index.jsp?TaskID=9&CardTask=7&CardID=<%=card.getJPOS_CardId() %>"><img src="images/modify.jpg"></a>
                                                    <a href="index.jsp?TaskID=9&CardTask=3&CardID=<%=card.getJPOS_CardId() %>"><img src="images/delete.jpg"></a>
                                                </td>
                                            </tr>
                                            <%
                                        }
