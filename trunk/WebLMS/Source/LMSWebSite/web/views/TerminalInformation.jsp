<%-- 
    Document   : TerminalInformation
    Created on : Jun 4, 2010, 12:17:10 PM
    Author     : NKLapTop
--%>
                                ...
                                <div class="content">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td><%=TerInfor.getTID() %></td>
                                        </tr>
                                        <tr>
                                            <th align="left"  width="100px"> Mã PIN : </th>
                                            <td><%=TerInfor.getPIN() %></td>
                                        </tr>
                                        <tr>
                                            <th align="left"> Mã kích hoạt :</th>
                                            <td><%=TerInfor.getActiveCode()%></td>
                                        </tr>
                                        <tr>
                                            <th align="left" width="130px"> Số lần kích hoạt cho phép : </th>
                                            <td><%=TerInfor.getRetry() %></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td colspan="2" align="center"><img src="images/modify.jpg"><a href="index.jsp?TaskID=7&TerTask=3&TID=<%=TerInfor.getTID() %>" title="Thay đổi thông tin">Thay đổi thông tin thiết bị</a></td>
                                        </tr>
                                    </table>
