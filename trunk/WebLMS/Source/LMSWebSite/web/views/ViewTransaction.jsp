<%-- 
    ...
    Created on : Jun 18, 2010, 7:29:41 PM
    Author     : NKLapTop
--%>
                ...
                <tbody align="left">
                    ...
                    <tr>
                        <td colspan="9" style="padding-top:4px">
                            <div class="path">
                                <a href="index.jsp">Trang chủ</a>&#8250; <a href="index.jsp?TaskID=17">Thông tin giao dịch</a> &#8250;
                            </div>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <div >
                                <div class="content" align="center">
                                    <form action="index.jsp" method="Get" style="padding-top:50px;">
                                        <input type="hidden" value="4" name="TaskID">
                                        <table>
                                            <tr>
                                                <td width="40px"><img src="images/transaction.jpg" alt="Mã khách hàng"></td>
                                                <td>Vui lòng nhập mã khách hàng của bạn</td>
